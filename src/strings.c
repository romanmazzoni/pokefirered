...
const u8 gText_MenuPlayer[] = _("Paul");
...
const u8 gText_OakForbidsUseOfItemHere[] = _("OAK: Paul!\nThis isn't the time to use that!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayerUsedVar2[] = _("Paul used the\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepelEffectsLingered[] = _("But the effects of a REPEL\nlingered from earlier.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildLured[] = _("Paul used the\n{STR_VAR_2}.\pWild POKéMON will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("Paul used the\n{STR_VAR_2}.\pWild POKéMON will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SPc[] = _("Paul's PC");
...
const u8 gString_BattleRecords_PlayersBattleResults[] = _("Paul's BATTLE RESULTS");
...
const u8 gText_PlayerScurriedToCenter[] = _("Paul scurried to a POKéMON CENTER,\nprotecting the exhausted and fainted\nPOKéMON from further harm‥\p");
const u8 gText_PlayerScurriedBackHome[] = _("Paul scurried back home, protecting\nthe exhausted and fainted POKéMON from\nfurther harm‥\p");
