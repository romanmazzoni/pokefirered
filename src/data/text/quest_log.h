...
const u8 gText_QuestLog_SwitchMon1WithMon2[] = _("Paul switched the POKéMON\n{STR_VAR_1} with {STR_VAR_2}.");
...
const u8 gText_QuestLog_UsedTheItem[] = _("Paul used the\n{STR_VAR_1}.");
...
const u8 gText_QuestLog_WithdrewItemFromPC[] = _("Paul withdrew the item {STR_VAR_1}\nfrom the PC.");
...
const u8 gText_QuestLog_GaveMonHeldItem2[] = _("Paul made {STR_VAR_1} hold the item\n{STR_VAR_2}.");
...
const u8 gText_QuestLog_LeftTownsLocationForNextDestination[] = _("Paul left {STR_VAR_1}'s\n{STR_VAR_2} for the next\ndestination.");
const u8 gText_QuestLog_PlayedGamesAtGameCorner[] = _("Played a lot of games at the ROCKET\nGAME CORNER in {STR_VAR_1}.");
const u8 gText_QuestLog_RestedAtHome[] = _("Paul rested comfortably at home.");
const u8 gText_QuestLog_LeftOaksLab[] = _("Paul left PROF. OAK's POKéMON\nRESEARCH LAB.");
...
const u8 gText_QuestLog_HadGreatTimeInSafariZone[] = _("Paul had a great time with POKéMON\nin the SAFARI ZONE.");
...
const u8 gText_QuestLog_UsedEscapeRope[] = _("Paul used an ESCAPE ROPE to get\nout from {STR_VAR_2}.");
...
const u8 gText_QuestLog_DepartedFromLocationToNextDestination[] = _("Paul departed from\n{STR_VAR_2} and made way\nto the next destination.");
const u8 gText_QuestLog_ObtainedItemInLocation[] = _("Here in {STR_VAR_1}, Paul\nobtained the item {STR_VAR_2}.");
const u8 gText_QuestLog_ArrivedInLocation[] = _("Arrived in {STR_VAR_1}.");
const u8 gText_QuestLog_SavedGameAtLocation[] = _("And Paul saved the game at this\nlocation: {STR_VAR_1}.");
