...
static const u16 sHoennSpeciesIdToCryId[] =
{
    ...
    [SPECIES_SCORBUNNY - HOENN_MON_SPECIES_START] = CRY_CASTFORM,
    [SPECIES_RABOOT - HOENN_MON_SPECIES_START] = CRY_NUZLEAF,
    [SPECIES_CINDERACE - HOENN_MON_SPECIES_START] = CRY_REGIROCK,
};
